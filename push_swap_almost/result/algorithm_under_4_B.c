...
static void	sort_at_3_B(t_Stack *a, t_Stack *b, int cnt, Pushswap *p)
{
	t_ListNode	*ptr;
...
static void	sort_over_2_B(t_Stack *a, t_Stack *b, int cnt, Pushswap *p)
{
	t_ListNode	*ptr;
...
void	sort_under_4_B(t_Stack *a, t_Stack *b, int cnt, Pushswap *p)
{
	int			num;
	t_ListNode	*ptr;
